...
namespace Dpr::UI {
    struct SoftwareKeyboard : ILClass<SoftwareKeyboard> {
        ...
        static inline System::String::Object* InputCheck(System::String::Object* resultText, int32_t errorState) {
            return external<System::String::Object*>(0x0184a710, resultText, errorState);
        }
