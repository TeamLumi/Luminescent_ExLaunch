...
HOOK_DEFINE_INLINE(Handler_Waza_newGetFunc) {
    static void Callback(exl::hook::nx64::InlineCtx* ctx) {
        ...
        if (ACTIVATED_MOVE_HANDLERS[array_index(MOVES, "Pika Papow")]) Handlers_Move_PikaPapow(array);
        ...
        if (ACTIVATED_MOVE_HANDLERS[array_index(MOVES, "Veevee Volley")]) Handlers_Move_VeeveeVolley(array);
