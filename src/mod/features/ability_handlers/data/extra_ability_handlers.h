...
struct ExtraAbilityHandlers {
    ...
    Dpr::Battle::Logic::EventFactor::EventHandlerTable::Array* HandlerTable_Schooling = nullptr;
    Dpr::Battle::Logic::EventFactor::EventHandlerTable::Array* HandlerTable_Disguise = nullptr;
