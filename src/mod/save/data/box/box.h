...
static const nn::vector<const char*> boxDefaultStrings {
        ...
        "Box 26", "Box 27", "Box 28", "Box 29", "Box 30",
        "Box 31", "Box 32", "Box 33", "Box 34", "Box 35",
        "Box 36", "Box 37", "Box 38", "Box 39", "Box 40",
        "Box 41", "Box 42", "Box 43", "Box 44", "Box 45",
        "Box 46", "Box 47", "Box 48", "Box 49", "Box 50",
        "Box 51", "Box 52", "Box 53", "Box 54", "Box 55",
        "Box 56", "Box 57", "Box 58", "Box 59", "Box 60",
        "Box 61", "Box 62", "Box 63", "Box 64", "Box 65",
        "Box 66", "Box 67", "Box 68", "Box 69", "Box 70",
        "Box 71", "Box 72", "Box 73", "Box 74", "Box 75",
        "Box 76", "Box 77", "Box 78", "Box 79", "Box 80"
};
...
struct BoxSaveData {
    ...
    long GetByteCount() {
        long count = 0;
        count += Dpr::Box::SaveBoxData::_STR17::GetByteCount()*size; // 17*2 *80 2720 Bytes
        count += sizeof(System::Byte)*size; // 80 Bytes
        count += Dpr::Box::SaveBoxTrayData::GetByteCount()*size; // 10,320 Bytes
        return count;
    }
    ...
    long FromBytes(char* buffer, long buffer_size, long index) {
        ...
        //Initialize();
        //Logger::log("[FromBytes] Init completed.\n");
        if (buffer_size >= GetByteCount() + index)
        {
            ...
            Logger::log("[FromBytes] SerializedPoke memcpy() complete.\n");
            return index;
        }
